...
<head>
	...
	<link rel="stylesheet" href="${path}/resources/css/shop_list.css">
	<link rel="stylesheet" href="${path}/resources/css/bootstrap.min.css">
	<link rel="stylesheet" href="${path}/resources/css/costom.css">
...
<body>
	...
	<div class="container">
      							...
      							<form action="./evaluationRegisterAction.jsp" method="post">
        							...
        							<div class="form-row">
          								...
          								<div class="form-group col-sm-9">
											<input id="member_addr" type="text" class="form-control col-lg-8" maxlength="20" placeholder="주소" readonly> <br>
          								</div>
          								<div class="form-group col-sm-12">
											<input type="text" class="form-control" maxlength="20" placeholder="상세주소">
          								</div>
        							</div>
        							<div class="form-row">
			          					<div class="form-group col-sm-12">
            								<label>가게 전화번호</label>
											<input type="text" class="form-control" maxlength="20" placeholder="전화번호(-없이 입력)">
          								</div>
        							</div>
        							<div class="form-row">
			          					<div class="form-group col-sm-6">
											<label>로고 파일 업로드</label>
    										<input type="file">   
		...
		<div class="shop-list">
			<ul>
				<c:forEach var="store" items="${ shopList }" begin="0" end="3">
					<li>
						<div class="img-thumb">
							<a href="#">
